...
// 2024-09-15 21:28:44.708387672 UTC
    ...
    namespace schemas {
        ...
        namespace libclient_so {
            ...
            namespace C_CSPlayerPawn {
                ...
                constexpr std::ptrdiff_t m_flFlinchStack = 0x3168; // float32
                constexpr std::ptrdiff_t m_flVelocityModifier = 0x316C; // float32
                constexpr std::ptrdiff_t m_flHitHeading = 0x3170; // float32
                constexpr std::ptrdiff_t m_nHitBodyPart = 0x3174; // int32
                constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x3178; // bool
                constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x317C; // float32
                constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x3181; // bool
                constexpr std::ptrdiff_t m_ArmorValue = 0x3184; // int32
                constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x3188; // uint16
                constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x318A; // uint16
                constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x318C; // uint16
                constexpr std::ptrdiff_t m_nLastKillerIndex = 0x3190; // CEntityIndex
                constexpr std::ptrdiff_t m_bOldIsScoped = 0x3194; // bool
                constexpr std::ptrdiff_t m_bHasDeathInfo = 0x3195; // bool
                constexpr std::ptrdiff_t m_flDeathInfoTime = 0x3198; // float32
                constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x319C; // Vector
                constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x31A8; // GameTime_t
                constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x31AC; // bool
                constexpr std::ptrdiff_t m_angStashedShootAngles = 0x31B0; // QAngle
                constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x31BC; // Vector
                constexpr std::ptrdiff_t m_vecStashedVelocity = 0x31C8; // Vector
                constexpr std::ptrdiff_t m_angShootAngleHistory = 0x31D4; // QAngle[2]
                constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x31EC; // Vector[2]
                constexpr std::ptrdiff_t m_vecVelocityHistory = 0x3204; // Vector[2]
                constexpr std::ptrdiff_t m_PredictedDamageTags = 0x3220; // C_UtlVectorEmbeddedNetworkVar<PredictedDamageTag_t>
                constexpr std::ptrdiff_t m_nPrevHighestReceivedDamageTagTick = 0x3270; // GameTick_t
                constexpr std::ptrdiff_t m_nHighestAppliedDamageTagTick = 0x3274; // int32
            }
            ...
            namespace CBasePlayerController {
                ...
                constexpr std::ptrdiff_t m_nInButtonsWhichAreToggles = 0x788; // uint64
                constexpr std::ptrdiff_t m_nTickBase = 0x790; // uint32
                constexpr std::ptrdiff_t m_hPawn = 0x794; // CHandle<C_BasePlayerPawn>
                constexpr std::ptrdiff_t m_bKnownTeamMismatch = 0x798; // bool
                constexpr std::ptrdiff_t m_hPredictedPawn = 0x79C; // CHandle<C_BasePlayerPawn>
                constexpr std::ptrdiff_t m_nSplitScreenSlot = 0x7A0; // CSplitScreenSlot
                constexpr std::ptrdiff_t m_hSplitOwner = 0x7A4; // CHandle<CBasePlayerController>
                constexpr std::ptrdiff_t m_hSplitScreenPlayers = 0x7A8; // CUtlVector<CHandle<CBasePlayerController>>
                constexpr std::ptrdiff_t m_bIsHLTV = 0x7C0; // bool
                constexpr std::ptrdiff_t m_iConnected = 0x7C4; // PlayerConnectedState
                constexpr std::ptrdiff_t m_iszPlayerName = 0x7C8; // char[128]
                constexpr std::ptrdiff_t m_steamID = 0x850; // uint64
                constexpr std::ptrdiff_t m_bIsLocalPlayerController = 0x858; // bool
                constexpr std::ptrdiff_t m_iDesiredFOV = 0x85C; // uint32
            }
            // Parent: None
            // Fields count: 0
            //
            ...
            namespace C_CSGO_PreviewPlayer {
                constexpr std::ptrdiff_t m_animgraph = 0x3278; // CUtlString
                constexpr std::ptrdiff_t m_animgraphCharacterModeString = 0x3280; // CGlobalSymbol
                constexpr std::ptrdiff_t m_flInitialModelScale = 0x3288; // float32
            }
            ...
            namespace CCSPlayerController {
                constexpr std::ptrdiff_t m_pInGameMoneyServices = 0x888; // CCSPlayerController_InGameMoneyServices*
                constexpr std::ptrdiff_t m_pInventoryServices = 0x890; // CCSPlayerController_InventoryServices*
                constexpr std::ptrdiff_t m_pActionTrackingServices = 0x898; // CCSPlayerController_ActionTrackingServices*
                constexpr std::ptrdiff_t m_pDamageServices = 0x8A0; // CCSPlayerController_DamageServices*
                constexpr std::ptrdiff_t m_iPing = 0x8A8; // uint32
                constexpr std::ptrdiff_t m_bHasCommunicationAbuseMute = 0x8AC; // bool
                constexpr std::ptrdiff_t m_szCrosshairCodes = 0x8B0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_iPendingTeamNum = 0x8B8; // uint8
                constexpr std::ptrdiff_t m_flForceTeamTime = 0x8BC; // GameTime_t
                constexpr std::ptrdiff_t m_iCompTeammateColor = 0x8C0; // int32
                constexpr std::ptrdiff_t m_bEverPlayedOnTeam = 0x8C4; // bool
                constexpr std::ptrdiff_t m_flPreviousForceJoinTeamTime = 0x8C8; // GameTime_t
                constexpr std::ptrdiff_t m_szClan = 0x8D0; // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_sSanitizedPlayerName = 0x8D8; // CUtlString
                constexpr std::ptrdiff_t m_iCoachingTeam = 0x8E0; // int32
                constexpr std::ptrdiff_t m_nPlayerDominated = 0x8E8; // uint64
                constexpr std::ptrdiff_t m_nPlayerDominatingMe = 0x8F0; // uint64
                constexpr std::ptrdiff_t m_iCompetitiveRanking = 0x8F8; // int32
                constexpr std::ptrdiff_t m_iCompetitiveWins = 0x8FC; // int32
                constexpr std::ptrdiff_t m_iCompetitiveRankType = 0x900; // int8
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Win = 0x904; // int32
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Loss = 0x908; // int32
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Tie = 0x90C; // int32
                constexpr std::ptrdiff_t m_nEndMatchNextMapVote = 0x910; // int32
                constexpr std::ptrdiff_t m_unActiveQuestId = 0x914; // uint16
                constexpr std::ptrdiff_t m_nQuestProgressReason = 0x918; // QuestProgress::Reason
                constexpr std::ptrdiff_t m_unPlayerTvControlFlags = 0x91C; // uint32
                constexpr std::ptrdiff_t m_iDraftIndex = 0x948; // int32
                constexpr std::ptrdiff_t m_msQueuedModeDisconnectionTimestamp = 0x94C; // uint32
                constexpr std::ptrdiff_t m_uiAbandonRecordedReason = 0x950; // uint32
                constexpr std::ptrdiff_t m_bCannotBeKicked = 0x954; // bool
                constexpr std::ptrdiff_t m_bEverFullyConnected = 0x955; // bool
                constexpr std::ptrdiff_t m_bAbandonAllowsSurrender = 0x956; // bool
                constexpr std::ptrdiff_t m_bAbandonOffersInstantSurrender = 0x957; // bool
                constexpr std::ptrdiff_t m_bDisconnection1MinWarningPrinted = 0x958; // bool
                constexpr std::ptrdiff_t m_bScoreReported = 0x959; // bool
                constexpr std::ptrdiff_t m_nDisconnectionTick = 0x95C; // int32
                constexpr std::ptrdiff_t m_bControllingBot = 0x968; // bool
                constexpr std::ptrdiff_t m_bHasControlledBotThisRound = 0x969; // bool
                constexpr std::ptrdiff_t m_bHasBeenControlledByPlayerThisRound = 0x96A; // bool
                constexpr std::ptrdiff_t m_nBotsControlledThisRound = 0x96C; // int32
                constexpr std::ptrdiff_t m_bCanControlObservedBot = 0x970; // bool
                constexpr std::ptrdiff_t m_hPlayerPawn = 0x974; // CHandle<C_CSPlayerPawn>
                constexpr std::ptrdiff_t m_hObserverPawn = 0x978; // CHandle<C_CSObserverPawn>
                constexpr std::ptrdiff_t m_bPawnIsAlive = 0x97C; // bool
                constexpr std::ptrdiff_t m_iPawnHealth = 0x980; // uint32
                constexpr std::ptrdiff_t m_iPawnArmor = 0x984; // int32
                constexpr std::ptrdiff_t m_bPawnHasDefuser = 0x988; // bool
                constexpr std::ptrdiff_t m_bPawnHasHelmet = 0x989; // bool
                constexpr std::ptrdiff_t m_nPawnCharacterDefIndex = 0x98A; // uint16
                constexpr std::ptrdiff_t m_iPawnLifetimeStart = 0x98C; // int32
                constexpr std::ptrdiff_t m_iPawnLifetimeEnd = 0x990; // int32
                constexpr std::ptrdiff_t m_iPawnBotDifficulty = 0x994; // int32
                constexpr std::ptrdiff_t m_hOriginalControllerOfCurrentPawn = 0x998; // CHandle<CCSPlayerController>
                constexpr std::ptrdiff_t m_iScore = 0x99C; // int32
                constexpr std::ptrdiff_t m_vecKills = 0x9A0; // C_NetworkUtlVectorBase<EKillTypes_t>
                constexpr std::ptrdiff_t m_bMvpNoMusic = 0x9B8; // bool
                constexpr std::ptrdiff_t m_eMvpReason = 0x9BC; // int32
                constexpr std::ptrdiff_t m_iMusicKitID = 0x9C0; // int32
                constexpr std::ptrdiff_t m_iMusicKitMVPs = 0x9C4; // int32
                constexpr std::ptrdiff_t m_iMVPs = 0x9C8; // int32
                constexpr std::ptrdiff_t m_bIsPlayerNameDirty = 0x9CC; // bool
            }
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
